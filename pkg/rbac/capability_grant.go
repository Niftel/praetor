...
// Compatibility bridge: role-field grants are written into the capability model so
// enforcement sees runtime changes. These operate on sqlx.ExtContext so the same code serves both a
